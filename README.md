...
## 📌 Project Description
This project aims to analyze and predict the Human Development Index (HDI) using Machine Learning. 
HDI is a key statistic to measure and rank countries' levels of social and economic development based on 3 pillars:
1.  **Health**: Life Expectancy at Birth
2.  **Education**: Mean Years of Schooling & Expected Years of Schooling
3.  **Standard of Living**: GNI per Capita

We built a Flask web application with a trained RandomForest model to predict HDI score and classify countries into development tiers.

## 🚀 Key Features
- **Data Analysis**: EDA on UNDP HDI dataset
- **ML Model**: RandomForestRegressor trained to predict HDI Score
- **Web App**: Flask based interactive dashboard for prediction
- **Classification**: Classifies into 4 tiers - Low, Medium, High, Very High Human Development
...
- **Dataset**: UNDP Human Development Reports

## 📊 Dataset Columns
`Country, Year, Life_expectancy, Mean_years_schooling, Expected_years_schooling, GNI_per_capita, HDI`

## ⚡ Installation & Setup

1.  **Clone the repository**
    ```bash
    git clone https://github.com/bollisettidurgabhavani-tech/A-COMPREHENSIVE-MEASURE-OF-WELL-BEING-HDI-.git
    cd A-COMPREHENSIVE-MEASURE-OF-WELL-BEING-HDI-
